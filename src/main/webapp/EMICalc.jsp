...
<button class="tablink" onclick="openPage('SimpleCalculator', this, 'BROWN')" >Simple Calculator</button>
<button class="tablink" onclick="openPage('AgeCalculator', this, 'BROWN')" >Age Calculator</button>
<button class="tablink" onclick="openPage('EMICalculator', this, 'BROWN')" id="defaultOpen">EMI Calculator</button>
